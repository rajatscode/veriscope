...
function renderRuntimeCoverage(graph: CircuitGraph, report: CoverageReport): HTMLElement {
  ...
  explanation.textContent = 'Observed Activity counts live boolean values, primitive transitions, declared operation outcomes, and registered cross-coverage combinations. Transition gaps appear only for Planned Coverage generated by Veriscope.';
