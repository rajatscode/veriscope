...
export function App() {
  ...
  const humanTarget = useSignal<PlayerId>('p2', 'arena.humanTarget', { states: TARGET_STATES });
  ...
  const canSend2 = canPlay && attackBank.val >= 2 && !selectedTargetKo;
  const canSend4 = canPlay && attackBank.val >= 4 && !selectedTargetKo;
